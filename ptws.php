...
function ptws_enqueue_styles()
{
    ...
    wp_enqueue_style('new-royalslider-core-css-css', PTWS_PLUGIN_URL . "/royalslider/royalslider.css");
    wp_enqueue_style('rsDefaultInv-css-css', PTWS_PLUGIN_URL . "/royalslider/rs-default-inverted.css");
    wp_enqueue_style('visible_nearby_zoom-css-css', PTWS_PLUGIN_URL . "/royalslider/rs-visible-nearby-zoom.css");
}




function ptws_additional_page_head() {

    // Post object if needed
    //global $post;
    // Page conditional if needed
    //if( is_page() ){}
    $icons_url = PTWS_PLUGIN_URL . "/images/site_icons/";
    ?>
        ...
        <link rel="icon" type="image/png" sizes="48x48" href="<?php echo $icons_url ?>favicon-48x48.png">
        <link rel="apple-touch-icon" sizes="57x57" href="<?php echo $icons_url ?>apple-touch-icon-57x57.png">
        <link rel="apple-touch-icon" sizes="60x60" href="<?php echo $icons_url ?>apple-touch-icon-60x60.png">
        <link rel="apple-touch-icon" sizes="72x72" href="<?php echo $icons_url ?>apple-touch-icon-72x72.png">
        <link rel="apple-touch-icon" sizes="76x76" href="<?php echo $icons_url ?>apple-touch-icon-76x76.png">
        <link rel="apple-touch-icon" sizes="114x114" href="<?php echo $icons_url ?>apple-touch-icon-114x114.png">
        <link rel="apple-touch-icon" sizes="120x120" href="<?php echo $icons_url ?>apple-touch-icon-120x120.png">
        <link rel="apple-touch-icon" sizes="144x144" href="<?php echo $icons_url ?>apple-touch-icon-144x144.png">
        <link rel="apple-touch-icon" sizes="152x152" href="<?php echo $icons_url ?>apple-touch-icon-152x152.png">
        <link rel="apple-touch-icon" sizes="167x167" href="<?php echo $icons_url ?>apple-touch-icon-167x167.png">
        <link rel="apple-touch-icon" sizes="180x180" href="<?php echo $icons_url ?>apple-touch-icon-180x180.png">
        <link rel="apple-touch-icon" sizes="1024x1024" href="<?php echo $icons_url ?>apple-touch-icon-1024x1024.png">    
    <?php
...
function ptws_enqueue_scripts()
{
    ...
    wp_enqueue_script('new-royalslider-main-js-js', PTWS_PLUGIN_URL . '/royalslider/jquery.royalslider.js', array('jquery'), null, true);
...
add_action('wp_head', __NAMESPACE__ . '\ptws_additional_page_head' );
